<a href="{{ route($route) }}" class="flex lg:flex-row flex-col items-center relative py-5">
    ...
    <div
        class="box-1 h-full biru-muda-2 lg:w-[55%] w-full lg:absolute max-lg:p-5 right-0 flex-col justify-center flex lg:pl-40 lg:pr-20 right-0 max-lg:text-center">
