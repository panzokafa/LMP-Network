<div
 ...
 x-init="
        ...
        .notification((notification)=>{
            if(notification['type']== 'App\\Notifications\\MessageRead' && notification['conversation_id']== 1)
            {
...
class="w-full overflow-hidden">
    ...
    <header class="w-full sticky inset-x-0 flex pb-[5px] pt-[5px] top-0 z-10 bg-white border-b " >
        ...
        <div class="flex w-full items-center px-2 lg:px-4 gap-2 md:gap-5">
            ...
            <h6 class="font-bold truncate"> email </h6>
    ...
    id="conversation"  class="flex flex-col gap-3 p-2.5 overflow-y-auto  flex-grow overscroll-contain overflow-x-hidden w-full my-auto">
        ...
        <div @class([
            ...
            <p class="whitespace-normal truncate text-sm md:text-base tracking-wide lg:tracking-normal">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolores praesentium porro dignissimos error rem optio, perspiciatis ipsam quia similique quas a, nostrum aspernatur sed officiis! Illo deleniti quo ipsum aliquid.
            </p>
             ...
             method="POST" autocapitalize="off">
                ...
                <div class="grid grid-cols-12">
                     <input
                            ...
                            maxlength="1700"
                            class="col-span-10 bg-gray-100 border-0 outline-0 focus:border-0 focus:ring-0 hover:ring-0 rounded-lg  focus:outline-none p-2"
                     >
