...
Echo.private('users.{{ Auth()->User()->id }}')
    ...
    <header class="px-3 z-10 bg-white sticky top-0 w-full py-2">
        ...
        <div class="flex gap-3 items-center overflow-x-scroll p-2 bg-white">
            ...
            <button @click="type='deleted'" :class="{ 'bg-red-100 border-0 text-black': type == 'deleted' }"
                class="inline-flex justify-center items-center rounded-full gap-x-1 text-xs font-medium px-3 lg:px-5 py-1  lg:py-2.5 border ">
                Deleted
            </button>
                    ...
                    <a href="/"
                        ...
                        <div class="flex gap-x-2 items-center">
                                ...
                                <p class="grow truncate text-sm font-[100]">
                                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Obcaecati, voluptatem laudantium debitis exercitationem aliquam sit consequatur porro nam fugit corrupti distinctio blanditiis, quibusdam minima minus in adipisci reprehenderit? At, nulla?
                                </p>
