...
@section('content')
    ...
    <div class="lg:px-20 md:px-10 px-5">
        ...
        <div class="my-40 p-10 bg-white text-gray-700">
            ...
            <div class="bg-white overflow-hidden transition-all duration-500 max-h-0 peer-checked:max-h-40">
                <div class="p-4">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo cumque velit quaerat rem corrupti quia, fuga perferendis repudiandae alias quasi at distinctio, quos sunt natus fugiat cupiditate dolores blanditiis id.</p>
                </div>
            </div>
        </div>
