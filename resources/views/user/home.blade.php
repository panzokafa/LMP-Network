...
@section('content')
    ...
    <!--section-->
    <div>
        <div class="flex justify-between items-center px-20 py-14">
    ...
    <!--section-->
    <div class="mb-48">
        <div class="flex items-center justify-center px-44 justify-between ">
    ...
    <div class="mb-36">
        <div class="flex flex-row-reverse justify-between items-center pr-20">
            ...
            <div class="flex justify-end relative w-1/3 h-full">
                ...
                <img class="w-full relative bottom-10 right-0 z-20" src="{{ asset('images/panel.jpg') }}" alt="">
