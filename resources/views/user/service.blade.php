...
@section('content')
    <div class="px-20 py-36">
        ...
        <div class="inter w-1/2 mb-28">
            <div class="text-4xl font-bold">Product & Service</div>

            <div class="h-1 w-1/2 biru my-3"></div>

            <div class="text-xl">LMP offers essential infrastructure technology and specialized
                solutions that can be swiftly implemented to meet your business needs.
            </div>
        </div>
        <div class="grid grid-cols-2 gap-36">
            <div>
                <div class="text-5xl mb-5">LMP Networks</div>

                <div class="text-lg mb-12">LMP Networks provide Ultra High Density Solution
            ...
            <div>
                <div class="text-5xl mb-5">LMP Renewable Energy</div>

                <div class="text-lg mb-12">Renewable Energy is inexhaustible and canbe harnessed
            ...
            <div>
                <div class="text-5xl mb-5">LMP Centrinium</div>

                <div class="text-lg mb-12">LMP Centrinium provide wide range product solution
            ...
            <div>
                <div class="text-5xl mb-5">LMP Polymer</div>

                <div class="text-lg mb-12">At LMP Polymer we deliver solution for Plastic Product Design
            ...
            <div>
                <div class="text-5xl mb-5">LMP Services & Learning Center</div>

                <div class="text-lg mb-12">Whether it's engineering, on-site project management,
            ...
            <div>
                <div class="text-5xl mb-5">LMP Nex-T Edge DC 360</div>

                <div class="text-lg mb-12">As the first of Data Center Provider that serve Nation Wide of
