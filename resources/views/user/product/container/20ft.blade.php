    ...
    <div class="py-12 lg:px-20 sm:px-10 px-5">
        <div class="w-full flex lg:flex-row flex-col justify-between items-center mb-14 gap-12">
            ...
            <div class="inter  lg:w-1/2">
                <div class="title xl:text-4xl lg:text-3xl sm:text-2xl text-xl font-bold mb-5">20ft Container Data Center
                </div>


                <div class="desc lg:text-xl sm:text-lg mb-5">All in one 20F Container MDC fully integrated  with standard
                    rack,
                    ...
                    for outdoor deployment -35C ~ 55C ambient.
            ...
            <div class="flex items-center xl:justify-center lg:justify-end w-1/2 image">
                <img class="relative z-20 " src="{{ asset('images/product/container/20f.png') }}" alt="">
            </div>
        </div>
...
',
                    ...
                    $route = ['product.container.10ft', 'product.container.40ft', 'product.container.dual-container'];
                @endphp
                @for ($i = 0; $i < 3; $i++)
