    ...
    <div class="py-12 lg:px-20 sm:px-10 px-5">
        <div class="w-full flex lg:flex-row flex-col justify-between items-center mb-14 gap-12">
            ...
            <div class="inter  lg:w-1/2">
                <div class="title xl:text-4xl lg:text-3xl sm:text-2xl text-xl font-bold mb-5">40ft Container Data Center
                </div>


                <div class="desc lg:text-xl sm:text-lg mb-5">All in one 40F Container MDC fully integrated with standard
                    rack,
                    wall mount cooling,  AC/DC power, battery, power distribution, security,
                    monitoring and fire systems. IP55 protection and thermal insulated
                    for global deployment -35C ~ 55C ambient.
            ...
            <div class="flex items-center xl:justify-center lg:justify-end w-1/2 image">
                <img class="relative z-20 " src="{{ asset('images/product/container/40f.png') }}" alt="">
            </div>
        </div>
...
various options available',
            ...
            <div class="grid lg:grid-cols-2 grid-cols-1 gap-7">
                @php
                    $image = ['10f', '20f', 'expandable'];
                    $title = ['10F Container Data Center', '20F Container Data Center', 'Expandable 40F Container Data Center'];
                    $desc = [
...
',
                    ...
                    $route = ['product.container.10ft', 'product.container.20ft', 'product.container.dual-container'];
                @endphp
                @for ($i = 0; $i < 3; $i++)
