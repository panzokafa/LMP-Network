    ...
    <div class="py-12 lg:px-20 sm:px-10 px-5">
        <div class="w-full flex lg:flex-row flex-col justify-between items-center mb-14 gap-12">
            ...
            <div class="inter  lg:w-1/2">
                <div class="xl:text-4xl lg:text-3xl sm:text-2xl text-xl font-bold mb-5">MDC Rack Split Package Cooling</div>


                <div class="lg:text-xl sm:text-lg mb-5">3k – 10k MDC fully integrated with closed rack, rack
