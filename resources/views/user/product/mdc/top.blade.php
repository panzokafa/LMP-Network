    ...
    <div class="py-12 lg:px-20 sm:px-10 px-5">
        <div class="w-full flex lg:flex-row flex-col justify-between items-center mb-14 gap-12">
            ...
            <div class="inter  lg:w-1/2">
                <div class="xl:text-4xl lg:text-3xl sm:text-2xl text-xl font-bold mb-5 title">MDC With Top Package Cooling</div>
        ...
        <div>
            ...
            <div class="grid lg:grid-cols-2 grid-cols-1 gap-4">
                @php
                    ...
                    $title = ['MDC With Row Package Cooling', 'MDC With Row Split Package Cooling', 'MDC With Rack Split Package Cooling'];
                    $desc = [
