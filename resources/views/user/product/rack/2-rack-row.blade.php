    ...
    <div class="py-12 lg:px-20 sm:px-10 px-5">
        <div class="w-full flex lg:flex-row flex-col justify-between items-center mb-14 gap-12">
            ...
            <div class="inter  lg:w-1/2">
                <div class="title xl:text-4xl lg:text-3xl sm:text-2xl text-xl font-bold mb-5">2-Rack MDC With Row Cooling
                </div>


                <div class="desc lg:text-xl sm:text-lg mb-5">MDC fully integrated with 2 rack space, inrow cooling, AC/DC
                    power,
                    battery, power distribution, security, monitoring and fire systems.
                    IP55 protection and thermal insulated for outdoor deployment
                    -35C ~ 45C ambient.
                </div>
        ...
        <div>
            ...
            <div class="grid lg:grid-cols-2 grid-cols-1 gap-4">
                @php
                    $image = ['1-Rack', '2-Rack', '3-Rack'];
                    $title = ['1-Rack MDC With Rack Cooling', '2-Rack MDC With Rack Cooling', '3-Rack MDC With Rack Cooling'];
                    $desc = [
                        ...
                        'MDC fully integrated with 2 rack space,
                        rack cooling, AC/DC power, battery, power 
                        distribution, security, monitoring and fire
                        systems. IP55 protection and thermal insulated
                    ...
                    $route = ['product.rack.1', 'product.rack.2', 'product.rack.3'];
                @endphp
                @for ($i = 0; $i < 3; $i++)
