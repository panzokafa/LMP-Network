...
@section('content')
    ...
    <div class="flex flex-col relative lg:pb-48 pb-24 max-lg:px-10 max-lg:text-center">
        ...
        <div class="desc-2 relative z-20 lg:px-20 lg:text-2xl md:text-xl lg:w-5/6 tracking-wider lg:mb-32 mb-5">
        ...
        <div class="desc-2 relative z-20 lg:px-20 lg:text-2xl md:text-xl lg:w-5/6 tracking-wider self-end">
